...
libs-y += lib/
# HAVE_VENDOR_COMMON_LIB is not set
...
# CONFIG_SYS_FSL_DDR is not set
libs-$(CONFIG_SYS_FSL_DDR) += drivers/ddr/fsl/
# CONFIG_SYS_FSL_MMDC is not set
libs-$(CONFIG_SYS_FSL_MMDC) += drivers/ddr/fsl/
# CONFIG_ALTERA_SDRAM is not set
...
libs-$(CONFIG_API) += api/
# CONFIG_HAS_POST is not set
libs-$(CONFIG_HAS_POST) += post/
libs-y += test/
libs-y += test/dm/
# CONFIG_UT_ENV is not set
libs-$(CONFIG_UT_ENV) += test/env/
# CONFIG_UT_OVERLAY is not set
...
u-boot.elf: u-boot.bin
	@echo "CONFIG_SYS_TEXT_BASE = $(CONFIG_SYS_TEXT_BASE)"
	@$(OBJCOPY)  -B aarch64 -I binary -O elf64-littleaarch64 $< u-boot-elf.o
	@$(LD) u-boot-elf.o -o $@ --defsym=_start=$(CONFIG_SYS_TEXT_BASE) \
